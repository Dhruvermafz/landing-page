...
const Register = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      addressArr: Yup.string().required("Invalid address"),
      password: Yup.string()
    ...
    onSubmit: (values) => {
      ...
      const inputFields = document.querySelectorAll(
        "#add-new-adsress input[type='text']"
      );
  ...
  useEffect(() => {
    if (formik?.values?.dob !== "") {
      const ageValue =
        new Date().getFullYear() - Number(formik?.values?.dob?.split("-")[0]);
                ...
                <div className="overflow-hidden">
                  <table className="min-w-full text-center text-sm font-light">
                    ...
                    {userData.length !== 0 ? (
                          ...
                          return (
                            ...
                            >
                              ...
                              <tr className="flex min-h-full flex-1  justify-center">
                                <td
                                  className="w-1/2 whitespace-nowrap  px-6 py-4"
                                  onClick={() => updateUserData(ele.id)}
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                ...
                                <td
                                  className="w-1/2whitespace-nowrap  px-6 py-4 "
                                  onClick={() => deleteUserData(ele.id)}
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                      ...
                      <tbody>
                        <tr className="border-b dark:border-neutral-500   h-24 bg-lime-950 w-100">
                          <td colSpan="6" className="noDataTd">
                            No user found
                          </td>
                        </tr>
                      </tbody>
